...
已继续实现房源/交易扩展、新房分销、财务、人事、办公、营销、租赁托管、客关和积分分红，统一支持状态机、审批、消息、权限与审计。离职交接已专项化，支持房源、客源、钥匙和房源角色预览与事务性交接，完成后立即停用账号和会话。费用报销已专项化，支持员工申请、费用票据、店长审批、财务付款和付款凭证，并强制申请、审批、付款职责分离。考勤请假已专项化，支持上下班打卡、迟到早退判定、带原因修正、请假时段防重和分级审批。简易收支已专项化，支持门店现金账、成交关联、凭证、作废、期间汇总和 CSV 导出。岗位调动已专项化，支持职级、员工定级、调动审批和原店业务资产事务性交接。
