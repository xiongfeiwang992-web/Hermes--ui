...
已继续实现房源/交易扩展、新房分销、财务、人事、办公、营销、租赁托管、客关和积分分红，统一支持状态机、审批、消息、权限与审计。离职交接已专项化，支持房源、客源、钥匙和房源角色预览与事务性交接，完成后立即停用账号和会话。费用报销已专项化，支持员工申请、费用票据、店长审批、财务付款和付款凭证，并强制申请、审批、付款职责分离。
