...
export const MESSAGE_CHANNELS: MessageChannel[] = [
  ...
  },
  {
    key: "payment",
    label: "收付款",
    description: "佣金到账、收款驳回、意向金登记冲抵与退款、提成发放",
    kinds: ["payment", "payment_reject", "earnest_create", "earnest_apply", "earnest_refund", "commission_paid"],
  },
  {
    key: "follow",
    label: "跟进与带看",
    description: "待跟进提醒、非接盘人带看提醒、陪看邀请、他人跟进提醒",
    kinds: ["follow_due","view_non_holder","view_accompany","follow_create"],
  },
  {
    key: "house",
    label: "房源协作",
  ...
  },
  {
    key: "customer",
    label: "客源提醒",
    description: "私客掉公、公客认领、联系人登记、客源登记、客源合并、手工转公、客源更新相关提醒",
    kinds: ["customer_public_pool","customer_claim","customer_contact","customer_create","customer_merge","customer_to_public","customer_update"],
  },
  {
    key: "office",
    label: "办公协同",
